...
//                        Создаем анимацию
                        ViewAnimationUtils.createCircularReveal(rootView, x, y, startRadius.toFloat(), endRadius.toFloat()).apply {
                            duration = 500  //Устанавливаем время анимации
                            interpolator = AccelerateDecelerateInterpolator()  //Интерполятор для более естественной анимации
                            start()  //Запускаем
                        }

                        rootView.visibility = View.VISIBLE  //Выставляем видимость нашего элемента
                    }
